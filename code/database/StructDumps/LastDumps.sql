...
INSERT INTO `AttendsAudit` VALUES (1,2,1,'2024-03-06 10:09:44','DELETE'),(2,2,1,'2024-03-06 10:10:04','DELETE'),(3,2,7,'2024-03-10 10:42:42','DELETE'),(4,2,1,'2024-03-11 08:12:05','UPDATE'),(5,2,7,'2024-03-13 06:56:19','DELETE'),(6,11,7,'2024-03-13 06:57:49','DELETE');
...
INSERT INTO `Attends` VALUES (2,2),(3,7),(2,8),(3,8);
...
CREATE TABLE `LuxId_Mapping` (
  ...
  CONSTRAINT `userMapping_FK` FOREIGN KEY (`userMapping_FK`) REFERENCES `User` (`code_PK`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `LuxId_Mapping` VALUES (1,'8170deaf-39d0-4a8c-bf66-a6f90e1ec05d',8);
...
INSERT INTO `Review` VALUES (8,3,'Best cpoied event',7,11,'2024-03-18'),(9,4,'This was a very good event.',8,3,'2024-03-22');
...
-- Dump completed on 2024-03-24 19:07:57
